    ...
    while($fila =$res ->fetch_assoc()){
        $salida.= "<tr>
            ...
            <td class='botones'>
                ...
                <a onclick='newwin".$fila['paciente_id']."()' style='font-size: 22px; cursor:pointer;'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-person-dash' viewBox='0 0 16 16'>
